...
urlpatterns = [
    path('accounts/', TemplateView.as_view(template_name='account/profile.html'), name='user-profile'), # required because if user deletes all social connections we show a back button
