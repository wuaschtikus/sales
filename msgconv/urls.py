...
urlpatterns = [
    ...
    path('convert/single', MsgConvSingleFiles.as_view(), name='msgconv_single_files'),
    path('convert/single/<str:id>', MsgConvSingleFiles.as_view(), name='msgconv_single_files'),
    path('convert/multiple', MsgConvMultipleFiles.as_view(), name='msgconv_multiple_files'),
    path('convert/multiple/<str:id>', MsgConvMultipleFiles.as_view(), name='msgconv_multiple_files'),
    ...
    path('convert/delete/<str:id>', DeleteFiles.as_view(), name='delete_files'),
